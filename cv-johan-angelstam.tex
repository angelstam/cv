...
I’m a full-stack developer with more than 20 years of experience in
both front-end and back-end development, with a strong background
working on both new and legacy systems. I pay great attention to
details and I’m both persistent and determined when working towards
clear and well-motivated goals. I have been involved in projects of
all sizes, from small companies where being pragmatic and flexible is
key, to process-heavy projects towards telecom. Skilled in developing
microservices and automated testing. As a team player, I am always
...
and community. Big interest right now are around DevOps, CI/CD and
automation.

% I like finding easy to understand solutions to user need.
...
connectivity, identities, and digital infrastructures. G+D is known
for its high-quality products and services, and its commitment to
...
\begin{compactitem}
  ...
  \item analyzed and improved code safety and security after routine checks
\end{compactitem}
\end{adjustwidth}
